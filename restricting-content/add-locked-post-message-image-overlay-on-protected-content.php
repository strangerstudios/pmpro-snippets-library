 ...
 */
function my_pmpro_protected_post_custom_post_thumbnail_html( $html, $post_id, $post_thumbnail_id, $size, $attr ) {
	global $pmpro_pages;
	...
	// Member has access, return the original HTML.
...
add_filter( 'post_thumbnail_html', 'my_pmpro_protected_post_custom_post_thumbnail_html', 10, 5 );