 ...
 * Once added to your site add the following to the end of your URL in order to run the script `/wp-admin/?assign_levels_posts=true`
 *
 ...
 */
function my_pmpro_bulk_assign_levels_to_posts(){
...
add_action( 'admin_init', 'my_pmpro_bulk_assign_levels_to_posts' );
